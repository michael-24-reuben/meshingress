---
name: meshingress-readme
description: Use when creating or updating the Meshingress root README.md from repository source files, especially to describe Meshingress architecture, MCP tool modules, configuration, scopes, dispatch, audit, secrets, tool-authoring workflow, and architect planning conventions.
metadata:
  short-description: Create or update the Meshingress README
---
