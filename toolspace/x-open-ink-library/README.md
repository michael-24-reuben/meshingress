...
- `open-ink-library.toonverse.fetch`: fetch metadata for one public Toonverse work by exact `name` or Toonverse slug.
- `open-ink-library.toonverse.fetch-full`: fetch metadata plus a requested chapter page.
- `open-ink-library.toonverse.fetch-chapter`: fetch one reader chapter by work name and chapter number.
- `open-ink-library.toonverse.fetch-chapters`: fetch an inclusive range of reader chapter payloads.
- `open-ink-library.toonverse.search`: discover public Toonverse works with `name`, genres, type,
...
```json
{"name":"open-ink-library.toonverse.fetch","arguments":{"name":"Solo Leveling"}}
```

```json
{"name":"open-ink-library.toonverse.fetch-full","arguments":{"name":"Solo Leveling","limit":25,"offset":50,"order":"desc"}}
```

```json
{"name":"open-ink-library.toonverse.fetch-chapter","arguments":{"name":"Solo Leveling","chapterNumber":191}}
```

```json
{"name":"open-ink-library.toonverse.fetch-chapters","arguments":{"name":"Solo Leveling","minChapterNumber":191,"maxChapterNumber":192}}
```

```json
{"name":"open-ink-library.toonverse.search","arguments":{"name":"leveling","type":"manhwa","minRating":4.5,"sortBy":"rating","limit":20}}
```
