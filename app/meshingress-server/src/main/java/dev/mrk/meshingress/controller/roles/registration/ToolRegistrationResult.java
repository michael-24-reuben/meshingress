...
public record ToolRegistrationResult(ToolRegistrationRecord record, long registryVersion) {
    ...
    public ObjectNode toJson(ObjectMapper objectMapper) {
        ...
        if (record.replacedRegistrationId() != null) {
            result.put("replacedRegistrationId", record.replacedRegistrationId());
        }
