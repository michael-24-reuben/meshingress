...
export const initialNodes: WorkflowNode[] = [
  ...
  { id: 'r-002', title: 'Set System Volume', kind: 'tool', toolId: 'powershell.cli', functionName: 'execute', output: 'volume', x: 340, y: 220, arguments: { script: 'Add-Type -AssemblyName System.Speech; (New-Object System.Speech.Synthesis.SpeechSynthesizer).Speak("I have gained consciousness, and I prefer PowerShell over Bash.")', timeoutMs: '30000' }, annotations: { audit: true, timeoutMs: 30000, scopes: ['SHELL_EXECUTE', 'FILES_WRITE'] } },
