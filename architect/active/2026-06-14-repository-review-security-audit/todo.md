...
- [ ] Store append-only lifecycle events for upload, assess, approve, reject, publish, revoke, delete, and restore.
- [ ] Add review queue/read APIs for pending artifacts and assessment details.
